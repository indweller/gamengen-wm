...
from reward import MarioRewardWrapper
...
if __name__ == "__main__":
    ...
    for world in range(1, 9):
        for stage in range(1, 4):
            CONFIG["env"]["env_id"] = f"SuperMarioBros-{world}-{stage}-v0"
            print("Configuration:")
            ...
            resume_path = f"./models/model_{world}_{stage}.zip" if not args.force_fresh else None
